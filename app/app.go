...
import (
	...
	prysmmodule "prysm/x/prysm"
	prysmmodulekeeper "prysm/x/prysm/keeper"
	prysmmoduletypes "prysm/x/prysm/types"
...
// any overrides above
var (
	// DefaultNodeHome default home directories for prysm3
...
type App struct {
	*baseapp.BaseApp
	...
	prysmKeeper prysmmodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		prysmmoduletypes.StoreKey, wasmtypes.StoreKey,
	...
	*/
	...
	app.prysmKeeper = *prysmmodulekeeper.NewKeeper(
		appCodec,
		keys[prysmmoduletypes.StoreKey],
		keys[prysmmoduletypes.MemStoreKey],
		app.GetSubspace(prysmmoduletypes.ModuleName),
	)
	prysmModule := prysmmodule.NewAppModule(appCodec, app.prysmKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(prysmmoduletypes.ModuleName)
